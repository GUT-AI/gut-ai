...
No, not at all. Neither Co-Founders nor Genesis users get any "special privileges", but each one of them is something like *primus inter pares* (i.e. first among equals). This ensures that all subsequent `governance token holders <https://gutai.miraheze.org/wiki/Governance_token_holders>`_ who will join later on will not be disadvantaged in any way.
